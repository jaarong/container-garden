...
const Banner = ({ title, featuredImage }: Props) => (
  ...
  <div className="bg-local bg-cover bg-no-repeat w-full h-full max-w-screen-lg mx-auto min-h-2/5 lg:min-h-3/5 flex items-center justify-right" style={{backgroundImage: 'url('+featuredImage.src+')'}} >
