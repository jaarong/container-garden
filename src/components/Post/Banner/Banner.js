...
const Banner = ({ title, featuredImage }: Props) => (
  ...
  <div className="bg-local bg-cover bg-no-repeat w-full h-full max-w-screen-lg mx-auto min-h-3/4 flex items-center justify-right" style={{backgroundImage: 'url('+featuredImage+')'}} >
